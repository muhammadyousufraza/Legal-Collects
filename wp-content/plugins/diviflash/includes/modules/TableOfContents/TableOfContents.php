...
class DIFL_TableOfContents extends ET_Builder_Module {
	...
	public function get_fields() {
		...
		$content_settings = [
			...
			'highlight_active_link' => [
				...
				'description'      => __( 'This will only work if you have the sticky feature enabled.', 'divi_flash' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'basic_option',
				'default'          => 'on',
				'default_on_front' => 'on',
	...
	protected function get_style_fields() {
		...
		$content_style = array_merge( [
			...
			'active_link_color'  => [
				...
				'tab_slug'       => 'advanced',
				'toggle_slug'    => 'content_style',
				'show_if'        => [ 'highlight_active_link' => 'on' ],
			],
		], $content_spacing );

		return array_merge( $header_style, $content_style );
	}
	...
	public function get_advanced_fields_config() {
		...
		$advanced_fields['fonts']['heading_1'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_1 > li > a',
				'hover' => '%%order_class%% .body_container .difl_heading_level_1 > li > a:hover',
			],
			'toggle_slug' => 'heading',
			'tab_slug'    => 'advanced',
			'sub_toggle'  => 'h1',
		...
		$advanced_fields['fonts']['heading_2'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_2 > li > a',
				'hover' => '%%order_class%% .body_container .difl_heading_level_2 > li > a:hover',
			],
			'tab_slug'    => 'advanced',
			'toggle_slug' => 'heading',
			'sub_toggle'  => 'h2',
		...
		$advanced_fields['fonts']['heading_3'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_3 > li > a',
				'hover' => '%%order_class%% .body_container .difl_heading_level_3 > li > a:hover',
			],
			'toggle_slug' => 'heading',
			'tab_slug'    => 'advanced',
			'sub_toggle'  => 'h3',
		...
		$advanced_fields['fonts']['heading_4'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_4 > li > a',
				'hover' => '%%order_class%% .body_container .difl_heading_level_4 > li > a:hover',
			],
			'toggle_slug' => 'heading',
			'tab_slug'    => 'advanced',
			'sub_toggle'  => 'h4',
		...
		$advanced_fields['fonts']['heading_5'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_5 > li > a',
				'hover' => '%%order_class%% .body_container .difl_heading_level_5 > li > a:hover',
			],
			'toggle_slug' => 'heading',
			'tab_slug'    => 'advanced',
			'sub_toggle'  => 'h5',
		...
		$advanced_fields['fonts']['heading_6'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_6 > li > a',
				'hover' => '%%order_class%% .body_container .difl_heading_level_6 > li > a:hover',
			],
			'toggle_slug' => 'heading',
			'tab_slug'    => 'advanced',
			'sub_toggle'  => 'h6',
		...
		$advanced_fields['fonts']['heading_font_1'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_1 > li::marker',
				'hover' => '%%order_class%% .body_container .difl_heading_level_1 > li::marker:hover',
			],
			'toggle_slug' => 'marker_settings',
			'tab_slug'    => 'general',
			'show_if'     => [
		...
		$advanced_fields['fonts']['heading_font_2'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_2 > li::marker',
				'hover' => '%%order_class%% .body_container .difl_heading_level_2 > li::marker:hover',
			],
			'toggle_slug' => 'marker_settings',
			'tab_slug'    => 'general',
			'show_if'     => [
		...
		$advanced_fields['fonts']['heading_font_3'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_3 > li::marker',
				'hover' => '%%order_class%% .body_container .difl_heading_level_3 > li::marker:hover',
			],
			'toggle_slug' => 'marker_settings',
			'tab_slug'    => 'general',
			'show_if'     => [
		...
		$advanced_fields['fonts']['heading_font_4'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_4 > li::marker',
				'hover' => '%%order_class%% .body_container .difl_heading_level_4 > li::marker:hover',
			],
			'toggle_slug' => 'marker_settings',
			'tab_slug'    => 'general',
			'show_if'     => [
		...
		$advanced_fields['fonts']['heading_font_5'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_5 > li::marker',
				'hover' => '%%order_class%% .body_container .difl_heading_level_5 > li::marker:hover',
			],
			'toggle_slug' => 'marker_settings',
			'tab_slug'    => 'general',
			'show_if'     => [
		...
		$advanced_fields['fonts']['heading_font_6'] = [
			...
			'css'         => [
				'main'  => '%%order_class%% .body_container .difl_heading_level_6 > li::marker',
				'hover' => '%%order_class%% .body_container .difl_heading_level_6 > li::marker:hover',
			],
			'toggle_slug' => 'marker_settings',
			'tab_slug'    => 'general',
			'show_if'     => [
	...
	protected function get_settings() {
		...
		foreach ( $headings as $heading ) {
			...
			$level    = str_replace( 'h', '', $heading );
			$selector = ".difl_table_of_contents .body_container.icon .difl_heading_level_$level > li > span.et-pb-icon";
			...
			$this->generate_generic_style( "marker_icon_space_heading_$heading", ".difl_table_of_contents .body_container.icon .difl_heading_level_$level > li > a", 'margin-left' );
		}
			...
			(() => {
					...
					const generate_markup = toc => {
						...
						const build_list = ( entries, depth = 1 ) => {
							...
							const icon_settings = get_settings( `marker_icon_h${ depth }` );
					...
					const get_settings = ( key = 'all' ) => {
						const toc_main = document.querySelector( '.difl_table_of_contents' );
					...
					const is_closest = ( element, selectors ) => {
						...
						element.classList.forEach( class_name => {
							...
							if ( selectors.split( ',' ).some( selector => element.closest( `.${ selector }` ) ) ) {
								matched = true;
							}
						} )
					...
					const generate_toc = () => {
						const toc_main = document.querySelector( '.difl_toc_main_container' );
					...
					const toggle_header = () => {
						...
						const sections = document.querySelectorAll( '[id^="difl-toc"]' );
					...
					const handle_active_color = () => {
						...
						const links = document.querySelectorAll( '.difl_toc_main_container .body_container a[href^="#difl-toc"]' );
