...
= 2.0.15 =
* Fixed: Security improvements (XSS issue in the backend, thanks to Ayato Shitomi for reporting)

= 2.0.14 =
* Fixed: Other user roles cannot view calendar
...
= 2.0.8.2 =
* Fixed: Updated block_categories depcrecated hook
